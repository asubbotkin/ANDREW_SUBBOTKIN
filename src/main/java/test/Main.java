...
public class Main {
    public static void main(String[] args) {
        ...
        Invioce newInvoice1 = new Invioce("ashfdashgdf", "euryweoiuy", 4, 67.4);
        Invioce newInvoice2 = new Invioce("ashfdashgdf", "ehjkhy", 3, -2);
        Invioce newInvoice3 = new Invioce("ashfdashgdf", "iuouyieoiuy", 2, 95.1);
